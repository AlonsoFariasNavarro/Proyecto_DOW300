        ...
        <div class="row">
            ...
            <div class="col d-flex flex-column py-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('estudiante.update',$estudiante->rut)}}" method="POST">
                            @method('PUT')
                            @csrf
                            <div>
                                <label for="rut">RUT</label>
                                <input for="rut" id="rut" name="rut" class="form-control" type="text" value="{{$estudiante->rut}}">
                            </div>
                            <div>
                                <label for="nombre">Nombre</label>
                                <input for="nombre" id="nombre" name="nombre" class="form-control" type="text" value="{{$estudiante->nombre}}">
                            </div>
                            <div>
                                <label for="apellido">Apellido</label>
                                <input for="apellido" id="apellido" name="apellido" class="form-control" type="text" value="{{$estudiante->apellido}}">
                            </div>
                            <div>
